...
const InstallPWA: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleOpenPrompt = () => {
      if (deferredPrompt) {
        ...
        alert('لتثبيت التطبيق على سطح المكتب، انقر على أيقونة التثبيت (شاشة مع سهم) في شريط عنوان المتصفح (شريط الرابط) بالأعلى. إذا لم تظهر، يمكنك التثبيت من قائمة إعدادات المتصفح.');
      }
    };
  ...
  const handleInstallClick = async () => {
    ...
    // Scenario C: Desktop without prompt (e.g. already installed or unsupported)
    else {
      alert('لتثبيت التطبيق على سطح المكتب، انقر على أيقونة التثبيت (شاشة مع سهم) في شريط عنوان المتصفح (شريط الرابط) بالأعلى. إذا لم تظهر، يمكنك التثبيت من قائمة إعدادات المتصفح.');
    }
  };
